      ...
      <div className="bg-dark">
        <div className="teacher__container container">
          <div className="teacher__content">
            <span className="teacher__content-top-title">
              {" "}
              UnitDev jamoasi{" "}
            </span>
            <h2 className="teacher__content-center-title">O’qituvchilarimiz</h2>
            <p className="teacher__content-sub-text">
              Problems trying to resolve the conflict between the two major
              realms of classNameical physics: Newtonian mechanics
            </p>
            <ul className="teacher__cards">
              <li className="teacher__card">
                <img
                  src="1"
                  width="238"
                  height="231"
                ...
                <footer className="teacher__footer">
                  <h3 className="teacher__footer-title">Julian Jameson</h3>
                  <span className="teacher__footer-job">Profession</span>
                  <ul className="teacher__medias-list">
                    <li className="teacher-medias-item">
